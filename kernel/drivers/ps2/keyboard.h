...
#define KB_KEY_SUPER    0x99   /* Super/Windows/Command key */
...
#define KB_KEY_SUPER_M  0xA4   /* Super modifier state index */
...
int  keyboard_super(void);   /* 1 when Super/Windows key is held */
